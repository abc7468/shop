...
class OrderServiceTest {
    ...
    public void 상품주문() throws Exception{
        ...
        Item book = createBook("장성현의 Spring", 10000, 10);
    ...
    public void 주문취소() throws Exception{
        ...
        assertEquals(OrderStatus.CANCEL, getOrder.getStatus(),"주문 취소한 상품은 상품의 상태가 CANCEL이다.");
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("서울", "강가", "123-145"));
        em.persist(member);
        return member;
    }
